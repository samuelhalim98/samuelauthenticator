...
public class ProfileActivity extends AppCompatActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String image_url = "https://samuelauthenticator.000webhostapp.com/SamuelAuthenticator/php/profileimages/" + phone + ".jpg";
    ...
    void loadUserProfile() {
        class LoadUserProfile extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                ...
                String s = rh.sendPostRequest("https://samuelauthenticator.000webhostapp.com/SamuelAuthenticator/php/load_user.php", hashMap);
                return s;
            }
    ...
    void updateProfile(final String newemail, final String newname, final String newloc, final String oldpass, final String newpass) {
        class UpdateProfile extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                ...
                RequestHandler rh = new RequestHandler();
                String s = rh.sendPostRequest("https://samuelauthenticator.000webhostapp.com/SamuelAuthenticator/php/update_profile.php", hashMap);
                return s;
            }
